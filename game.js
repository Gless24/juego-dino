...
function mostrarQuiz() {
  ...
  setTimeout(function () {
    document.getElementById("btnQuizOk").focus();
  }, 20);
  try {
    window.scrollTo({ top: 0, behavior: "smooth" });
  } catch (e) {}
